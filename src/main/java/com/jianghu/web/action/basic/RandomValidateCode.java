...
public class RandomValidateCode {
	...
	private String randString = "0123456789qwertyuiopasdfghjklzxcvbnmABCDEFGHIJKLMNOPQRSTUVWXYZ";// 随机产生的字符串
	...
	public void getRandcode(HttpServletRequest request, HttpServletResponse response) {
		...
		session.setAttribute(SessionConstants.VALIDDATE_CODE, randomString);
		graphics.dispose();
		try {
