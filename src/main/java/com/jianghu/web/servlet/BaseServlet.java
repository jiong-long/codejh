...
public class BaseServlet extends HttpServlet {
	...
	public void service(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			// 通过字符串执行反射方法
			// Object obj =
			// Class.forName("com.jianghu.web.servlet.BaseServlet").newInstance();
			// obj.getClass().getMethod("方法名", String.class).invoke(obj, "参数");
			method = this.getClass().getMethod(methodName, HttpServletRequest.class,
					HttpServletResponse.class);// 方法名，参数...
		} catch (Exception e) {
		 ...
		 */
		try {
			String result = (String) method.invoke(this, request, response);// 调用该反射方法
