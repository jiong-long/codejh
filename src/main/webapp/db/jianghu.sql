...
INSERT INTO `bc_sequence` VALUES ('BC_ITEM', '119');
...
CREATE TABLE `task` (
  ...
  `TARGET_DRTN_HR_CNT` int(10) DEFAULT NULL,
...
CREATE TABLE `taskpred` (
  `task_pred_id` int(8) NOT NULL,
  `task_id` int(8) DEFAULT NULL,
  `pred_task_id` int(8) DEFAULT NULL,
  `pred_type` varchar(30) DEFAULT NULL,
  `lag_hr_cnt` int(20) DEFAULT NULL,
